 ...
 * @author Bagher
 */
public class UpdateAssetFrameStep3 extends javax.swing.JFrame {

    /** Creates new form MainFrame */
    public UpdateAssetFrameStep3() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("مشاهده و تغییر دارایی - مشخصات دارایی فیزیکی");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new UpdateAssetFrameStep3().setVisible(true);
            }
        });
    }
