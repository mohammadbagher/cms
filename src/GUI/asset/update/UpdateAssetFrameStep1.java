 ...
 * @author Bagher
 */
public class UpdateAssetFrameStep1 extends javax.swing.JFrame {

    /** Creates new form MainFrame */
    public UpdateAssetFrameStep1() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("مشاهده و تغییر دارایی - مشخصات پایه");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new UpdateAssetFrameStep1().setVisible(true);
            }
        });
    }
