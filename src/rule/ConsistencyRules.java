...
public class ConsistencyRules  implements Serializable{
    ...
    private ConsistencyRules() {
        Rule rule1 = new Rule("مساوی است با", 0);
        Rule rule2 = new Rule("بزرگتر است از", 1);
        Rule rule3 = new Rule("کمتر است از", 2);
        Rule rule4 = new Rule("بزرگتر مساوی است از", 3);
        Rule rule5 = new Rule("کمتر مساوی است از", 4);
        Rule rule6 = new Rule("وجود دارد در", 5);
        Rule rule7 = new Rule("در خود دارد", 6);
        Rule rule8 = new Rule("وجود ندارد در", 7);
        Rule rule9 = new Rule("در خود ندارد", 8);
        Rule rule10 = new Rule("برابر نیست با", 9);
        rules.add(rule1);
        rules.add(rule2);
        rules.add(rule3);
        rules.add(rule4);
